...
---
Note: A separate React frontend scaffold exists in bookstorereact for UI experimentation. The PHP app here is reference-only for the frontend task and must not be modified from that React code. The React app has no data integration yet.
