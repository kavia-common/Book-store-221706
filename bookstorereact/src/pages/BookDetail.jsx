  ...
  return (
    <div className="card">
      <div style={{ display:'flex', gap:24, alignItems:'flex-start', flexWrap:'wrap' }}>
        <div style={{ width:280, height:280, background:'#eef3f8', borderRadius:8, display:'flex', alignItems:'center', justifyContent:'center' }}>
          {book.image ? <img src={book.image} alt={book.title} style={{ maxWidth:'100%', maxHeight:'100%' }} /> : <span>No Image</span>}
        </div>
